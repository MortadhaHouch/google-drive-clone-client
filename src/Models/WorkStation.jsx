...
Source: https://sketchfab.com/3d-models/libro-arcano-animado-71c6a0f2a5fb44d5a881b49e070ab27c
Title: Libro Arcano animado
*/
...
export default function WorkStation(props) {
    ...
    const { nodes, materials, animations } = useGLTF("../assets/libro_arcano_animado.glb")
    ...
    return (
        ...
        <group name="Sketchfab_Scene">
            ...
            <group name="e1794e6b43bb438fafae60ac0b4d6265fbx" rotation={[Math.PI / 2, 0, 0]}>
                <group name="Object_2">
                <group name="RootNode">
                    <group
                    name="Camera"
...
useGLTF.preload("../assets/libro_arcano_animado.glb")